...
if __name__ == "__main__":
    ...
    # 根据此序列识别是否规定化过
    origin_colours = {'#E6C384': 627596, '#ffffff': 543237, '#ffde54': 485065, '#fff7d4': 149900, '#a78f2a': 88556, '#e2b71c': 77449, '#f9f28b': 75981, '#726735': 53384, '#fed940': 48114, '#c8e9e3': 33721}
    ...
    replace_standard = {'#726735': -2, '#a78f2a': -2, '#e2b71c': 0, '#fed940': 0, '#E6C384':0, '#ffde54': 1, 'f9f28b': 2, 'dfb600': -1, '#ffcc33': -2, '#F6EF37':1}
